...
import ku.cs.classroom_2.Controller.Nisit.ChecknameNisitSystem;
import ku.cs.classroom_2.Database.DBHelper;
import ku.cs.classroom_2.R;

public class CheckNisitCheckname extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_nisit_register);
        ...
        final ArrayAdapter<String> adapter = new ArrayAdapter<String>(CheckNisitCheckname.this, android.R.layout.simple_list_item_1);
        ...
        courseListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(CheckNisitCheckname.this, ""+ iid, Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(), CheckknameList.class);
