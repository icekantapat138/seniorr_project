...
public class CheckCourseOpen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_course_open);
        ...
        final ArrayAdapter<String> adapter = new ArrayAdapter<String>(CheckCourseOpen.this, android.R.layout.simple_list_item_1);
